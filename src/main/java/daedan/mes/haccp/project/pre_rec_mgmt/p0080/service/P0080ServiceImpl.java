...
import daedan.mes.haccp.project.pre_rec_mgmt.p0080.mapper.P0080Mapper;
 ...
 * <li>서브 업무명 : daedan.mes.haccp.project.pre_rec_mgmt.p0080.service</li>
 * <li>설 명 : P0080Service.java</li>
 * <li>작성일 : 2021. 10. 3.</li>
 * <li>작성자 : KMJ</li>
 * </ul>
 */
@Service
@Transactional
public class P0080ServiceImpl implements P0080Service {
    ...
    public Map<String, Object> sendInfo(Map<String, Object> param) throws SQLException {
        ...
        List<Map<String, Object>> selectFinalCheckList = p0080Mapper.selectFinalCheckList(param);
