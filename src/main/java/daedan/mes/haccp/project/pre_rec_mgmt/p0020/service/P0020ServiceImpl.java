...
import daedan.mes.haccp.project.pre_rec_mgmt.p0010.service.P0010Service;
import daedan.mes.haccp.project.pre_rec_mgmt.p0020.mapper.P0020Mapper;
 ...
 * <li>서브 업무명 : daedan.mes.haccp.project.pre_rec_mgmt.p0020.service</li>
 * <li>설 명 : P0020Service.java</li>
 * <li>작성일 : 2021. 10. 3.</li>
 * <li>작성자 : KMJ</li>
 * </ul>
 */
...
@Service("p020Service")
@Transactional
public class P0020ServiceImpl implements P0020Service {
    ...
    public Map<String, Object> selectList(Map<String, Object> param) {
        ...
        cntInfo = p0020Mapper.gridPagingCnt(param);
        totalCount = cntInfo.get("cnt").toString();
        result.put("totalCount", totalCount);
        result.put("data", p0020Mapper.gridPaging(param));
        return result;
    }
    /**
     * 추가 정보 조회
    ...
    public Map<String, Object> selectInfo(Map<String, Object> param) {
        Map<String, Object> result = new HashMap<String, Object>();
        result.put("selectSavedCheckList", p0020Mapper.selectSavedCheckList(param));
        List<Map<String, Object>> cleanImprv = p0020Mapper.selectPreCleanImprv(param);
        if(cleanImprv != null) {
    ...
    public Map<String, Object> insert(Map<String, Object> param) {
        ...
        for(Map<String, Object> row : gridData) {
            ...
            p0020Mapper.insertPreClean(row);

            confYn = row.get("confYn").toString();
            if(confYn.equals("N")) {
                p0020Mapper.insertPreCleanImprv(row);
            }
        }
        return result;
    }
    ...
    public Map<String, Object> update(Map<String, Object> param) {
        ...
        for(Map<String, Object> row : updatedRows) {
            ...
            row.put("userId", param.get("userId"));
            confYn = row.get("confYn").toString();
            cleanImprvOne = p0020Mapper.selectPreCleanImprvOne(row);
            if(confYn.equals("Y")) {
                p0020Mapper.updatePreClean(row);
                if(cleanImprvOne != null) {
                    p0020Mapper.deletePreCleanImprvOne(row);
                }
            } else if(confYn.equals("N")) {
                p0020Mapper.updatePreClean(row);
                if(cleanImprvOne != null) {
                    p0020Mapper.updatePreCleanImprv(row);
                } else {
    ...
    public Map<String, Object> delete(Map<String, Object> param) {
        Map<String, Object> result = new HashMap<String, Object>();
        p0020Mapper.deletePreClean(param);
        p0020Mapper.deletePreCleanImprv(param);
        return result;
    }
    ...
    public Map<String, Object> sendInfo(Map<String, Object> param) throws SQLException {
        ...
        List<Map<String, Object>> selectFinalCheckList = p0020Mapper.selectFinalCheckList(param);
    ...
    public List<Map<String, Object>> selectCheckList(Map<String, Object> param) throws SQLException {
        return p0020Mapper.selectCheckList(param);
    }
}
