package daedan.mes.haccp.project.pre_rec_mgmt.p0130.service;

import daedan.mes.haccp.project.pre_rec_mgmt.p0130.mapper.P0130Mapper;
 ...
 * <li>서브 업무명 : daedan.mes.haccp.project.pre_rec_mgmt.p0300.service</li>
 * <li>설 명 : P0130Service.java</li>
 * <li>작성일 : 2021. 10. 3.</li>
 * <li>작성자 : KMJ</li>
 * </ul>
 */
@Service
@Transactional
public class P0130ServiceImpl implements  P0130Service {
    ...
    public Map<String, Object> sendInfo(Map<String, Object> param) throws SQLException {
        ...
        List<Map<String, Object>> selectFinalCheckList = p0130Mapper.selectFinalCheckList(param);
