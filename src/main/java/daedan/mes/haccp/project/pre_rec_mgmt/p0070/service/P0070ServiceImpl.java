package daedan.mes.haccp.project.pre_rec_mgmt.p0070.service;

import daedan.mes.haccp.project.pre_rec_mgmt.p0070.mapper.P0070Mapper;
 ...
 * <li>서브 업무명 : daedan.mes.haccp.project.pre_rec_mgmt.p0070.service</li>
 * <li>설 명 : P0070Service.java</li>
 * <li>작성일 : 2021. 10. 3.</li>
 * <li>작성자 : KMJ</li>
 * </ul>
 */
...
@Service
@Transactional
public class P0070ServiceImpl implements  P0070Service {
    ...
    public Map<String, Object> sendInfo(Map<String, Object> param) throws SQLException {
        ...
        List<Map<String, Object>> selectFinalCheckList = p0070Mapper.selectFinalCheckList(param);
