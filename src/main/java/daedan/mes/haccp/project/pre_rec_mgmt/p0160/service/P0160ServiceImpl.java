package daedan.mes.haccp.project.pre_rec_mgmt.p0160.service;

import daedan.mes.haccp.project.pre_rec_mgmt.p0160.mapper.P0160Mapper;
 ...
 * <li>서브 업무명 : daedan.mes.haccp.project.pre_rec_mgmt.p0160.service</li>
 * <li>설 명 : P0160Service.java</li>
 * <li>작성일 : 2021. 10. 3.</li>
 * <li>작성자 : KMJ</li>
 * </ul>
 */
@Service
@Transactional
public class P0160ServiceImpl implements P0160Service {
    ...
    public Map<String, Object> selectList(Map<String, Object> param) throws SQLException {
        ...
        cntInfo = p0160Mapper.gridPagingCnt(param);
        totalCount = cntInfo.get("cnt").toString();
        result.put("totalCount", totalCount);
        result.put("data", p0160Mapper.gridPaging(param));
    ...
    public Map<String, Object> selectInfo(Map<String, Object> param) throws SQLException {
        Map<String, Object> result = new HashMap<String, Object>();
        result.put("data", p0160Mapper.selectInfo(param));
        return result;
    }
    ...
    public List<Map<String, Object>> selectItemList(Map<String, Object> param) throws SQLException {
        return p0160Mapper.selectItemList(param);
    }
    ...
    public Map<String, Object> selectCreateDt(Map<String, Object> param) throws SQLException {
        Map<String, Object> result = new HashMap<String, Object>();
        result.put("data", p0160Mapper.selectCreateDt(param));
        return result;
    }
    ...
    public Map<String, Object> sendInfo(Map<String, Object> param) throws SQLException {
        ...
        List<Map<String, Object>> selectFinalCheckList = p0160Mapper.selectFinalCheckList(param);
        Map<String, Object> recSeqMap = p0160Mapper.selectCountRecSeq(param);
