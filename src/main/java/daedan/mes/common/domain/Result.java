package daedan.mes.common.domain;
...
public class Result {
    ...
    private Object EqOptions;
    private Object SysOptions;
    ...
    public Result setEqOptions(Object data) {
        this.EqOptions = data;
        return this;
    }

    public Result setSysOptions(Object data) {
        this.SysOptions = data;
        return this;
