...
public class EquipController {
    ...
    public Result equipDeviceList(@RequestBody Map<String, Object> paraMap){
        Result result = Result.successInstance();
        paraMap.put("pageNo", StringUtil.convertPageNo(paraMap));
    ...
    public Result equipRunStatList(@RequestBody Map<String, Object> paraMap){
        Result result = Result.successInstance();
        paraMap.put("pageNo", StringUtil.convertPageNo(paraMap));
    ...
    public Result equipRunHstrList(@RequestBody Map<String, Object> paraMap){
        Result result = Result.successInstance();
        paraMap.put("pageNo", StringUtil.convertPageNo(paraMap));
    ...
    public Result equip(@RequestBody Map<String, Object> paraMap) {
        Result result = Result.successInstance();
        String tag = "EquipController.eqInfo=>";
        log.info(tag + "equipNo = " + paraMap.get("equipNo"));
    ...
    public Result equipInfo(@RequestBody Map<String, Object> paraMap, HttpServletRequest request) {
    ...
    public Result equip500Cond(@RequestBody Map<String, Object> paraMap){
        Result result = Result.successInstance();
    ...
    public Result comboEmbEquip(@RequestBody Map<String, Object> paraMap){
        Result result = Result.successInstance();
        Map<String,Object> rmap = new HashMap<String,Object>();
        paraMap.put("parCodeNo",Long.parseLong(env.getProperty("code.base.madein")));
        rmap.put("madeins",codeService.getComboCodeList(paraMap));
    ...
    public Result saveEqInfo(@RequestBody Map<String, Object> paraMap, HttpServletRequest request) {
    ...
    public Result equipMastInfo(@RequestBody Map<String, Object> paraMap) {
    ...
    public Result saveEquipMast(@RequestBody Map<String, Object> paraMap, HttpServletRequest request) {
    ...
    public Result equipMngrItemSave(@RequestBody Map<String, Object> paraMap, HttpServletRequest request) {
        String tag = "EquipController.saveEquip=>";
        Result result = Result.successInstance();
        paraMap.get("equipNo");
...
//        Map<String, Object> emMap = (Map<String, Object> )paraMap.get("eqInfo");
    ...
    public Result dropEquipMast(@RequestBody Map<String, Object> paraMap, HttpServletRequest request) {
    ...
    public Result dropEquip(@RequestBody Map<String, Object> paraMap, HttpServletRequest request) {
    ...
    public Result onlyEquipList(@RequestBody Map<String, Object> paraMap){
        Result result = Result.successInstance();
        String tag = "EquipController.EquipList =>";
        paraMap.put("pageNo", StringUtil.convertPageNo(paraMap));
        log.info(tag + "findTp = " + paraMap.get("findTp"));
    ...
    public Result getCheckItemList(@RequestBody Map<String, Object> paraMap){
        Result result = Result.successInstance();
        String tag = "EquipController.EquipList =>";
        paraMap.put("pageNo", StringUtil.convertPageNo(paraMap));
    ...
    public Result getErrorItemList(@RequestBody Map<String, Object> paraMap){
        Result result = Result.successInstance();
        String tag = "EquipController.EquipList =>";
        paraMap.put("pageNo", StringUtil.convertPageNo(paraMap));
    ...
    public Result saveCcpMetalReport(@RequestBody Map<String, Object> paraMap, HttpServletRequest request){
        Result result = Result.successInstance();
        paraMap.put("ipaddr", NetworkUtil.getClientIp(request));
    ...
    public Result reportSave(@RequestBody Map<String, Object> paraMap){
        String tag = "EquipController.saveModbusTmpr => ";
        Result result = Result.successInstance();
    ...
    public Result equipMngrItem(@RequestBody Map<String, Object> paraMap){
        Result result = Result.successInstance();
        String tag = "EquipController.EquipList =>";
    ...
    public Result equipMngrHstr(@RequestBody Map<String, Object> paraMap){
        Result result = Result.successInstance();
        String tag = "EquipController.EquipList =>";
    ...
    public Result equipMngrHstrDouble(@RequestBody Map<String, Object> paraMap){
        Result result = Result.successInstance();
        String tag = "EquipController.EquipList =>";
    ...
    public Result equipMngrHstrHdfdVer(@RequestBody Map<String, Object> paraMap){
        Result result = Result.successInstance();
        String tag = "EquipController.EquipList =>";
    ...
    public Result saveModbusTmpr(@RequestBody Map<String, Object> paraMap){
        String tag = "EquipController.saveModbusTmpr => ";
        Result result = Result.successInstance();
    ...
    public Result saveModbusHumy(@RequestBody Map<String, Object> paraMap){
        String tag = "EquipController.saveModbusHumy => ";
        Result result = Result.successInstance();
    ...
    public Result getEquipReportList(@RequestBody Map<String, Object> paraMap){
        Result result = Result.successInstance();
        paraMap.put("pageNo", StringUtil.convertPageNo(paraMap));
    ...
    public Result chatOn(@RequestBody Map<String, Object> paraMap){
