...
import daedan.mes.dash.mapper.Dash14Mapper;
...
@Service("dash14")
public class Dash14ServiceImpl implements  Dash14Service {
    ...
    public List<Map<String, Object>> getMakeRsltGroupDash(Map<String, Object> paraMap) {
        String tag = "dash30Service.getMakeRsltGroupDash => ";
        log.info(tag + " paraMap = " + paraMap.toString());
    ...
    public List<Map<String, Object>> getDashTotalMakeIndcRslt(Map<String, Object> paraMap) {
        String tag = "dash30Service.getDashTotalMakeIndcRslt => ";
        log.info(tag + " paraMap = " + paraMap.toString());
