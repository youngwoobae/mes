...
@RestController
@RequestMapping("/api/daedan/mes/dash14")
public class Dash14Controller {
    ...
    public Result getUserGroupDash(@RequestBody Map<String, Object> paraMap  , HttpSession session){
        ...
        Long custNo = uvo.getCustInfo().getCustNo();
        paraMap.put("custNo", custNo);
        result.setData(dash14.getUserGroupDash(paraMap));
    ...
    public Result getDashTotalMakeIndcRslt(@RequestBody Map<String, Object> paraMap  , HttpSession session){
        ...
        Long custNo = uvo.getCustInfo().getCustNo();
        paraMap.put("custNo", custNo);
        result.setData(dash03.getDashTotalMakeIndcRslt(paraMap));
        //SOL AddOn By KMJ AT 21.11.16
        if (uvo.getCustInfo().getActEvtLogYn().equals("Y")) {
            try {
